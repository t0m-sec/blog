...
def translate_markdown(content, metadata, model_name="claude-3-7-sonnet-20250219"):
    """
...
def translate_about_page(model_name="claude-3-7-sonnet-20250219"):
...
def main():
    ...
    model_name = translation_config.get("model", "claude-3-7-sonnet-20250219")
