...
def translate_markdown(content, metadata, model_name="claude-sonnet-4-6"):
    """
...
def translate_about_page(model_name="claude-sonnet-4-6"):
...
def main():
    ...
    model_name = translation_config.get("model", "claude-sonnet-4-6")
